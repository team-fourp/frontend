<template>
  <header class="flex items-center content-center py-3 px-2 relative">
    ...
    <Logotype class="ml-2" />
    <nav class="ml-auto flex flex-wrap max-h-8 items-center content-center invisible lg:visible">
    ...
    <div class="flex items-center content-center relative">
      ...
      <div class="main-search">
        <div class="bg-white flex items-center opacity-0 w-0 z-10 absolute inset-0 h-full py-3 px-2 search-input">
